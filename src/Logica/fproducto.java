...
public class fproducto {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String [] titulos={"ID","Producto","Descripcion","Unidad Medida","Precio Venta"}; //no tiene que ser igual al nombre de las columnas
        
        String [] registro = new String [5]; // Uno por cada campo
