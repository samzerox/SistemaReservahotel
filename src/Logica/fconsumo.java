...
public class fconsumo {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String [] titulos={"ID","idreserva","idproducto","producto","cantidad","Precio Venta","Estado"}; //no tiene que ser igual al nombre de las columnas
        
        String [] registro = new String [7]; // Uno por cada campo
