...
public class ftrabajador {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "Nombre", "Apaterno", "Amaterno", "Doc", "Numero Documento", "Direccion", "Telefono", "Email", "Sueldo","Acceso","Login","Clave","Estado"}; //no tiene que ser igual al nombre de las columnas

        String[] registro = new String[14]; // Uno por cada campo
    ...
    public DefaultTableModel login(String login, String password) {
        ...
        String[] titulos = {"ID", "Nombre", "Apaterno", "Amaterno", "Acceso","Login","Clave","Estado"}; //no tiene que ser igual al nombre de las columnas

        String[] registro = new String[8]; // Uno por cada campo
