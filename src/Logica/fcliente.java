...
public class fcliente {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "Nombre", "Apaterno", "Amaterno", "Doc", "Numero Documento", "Direccion", "Telefono", "Email", "Codigo"}; //no tiene que ser igual al nombre de las columnas

        String[] registro = new String[10]; // Uno por cada campo
